<template>
  <div class="news-detail">
    ...
    <div v-if="news" class="article-container">
      <header class="article-header">
        <div class="article-category">乡村新闻</div>
        <h1 class="article-title">{{ news.title }}</h1>
        <div class="article-meta">
          <div class="author-info">
            <div class="author-avatar">👤</div>
            <div class="author-details">
              <span class="author-name">村委会</span>
              <span class="author-role">官方发布</span>
            </div>
          </div>
          <div class="meta-stats">
            <div class="meta-item">
              <span class="meta-icon">📅</span>
              <span class="meta-text">{{ news.date }}</span>
            </div>
            <div class="meta-item">
      ...
      <div class="article-tags">
        <span class="tag-item">#乡村振兴</span>
        <span class="tag-item">#美丽新农村</span>
        <span class="tag-item">#幸福村</span>
      </div>
    ...
    <div v-else class="not-found">
      ...
      <p>新闻不存在</p>
      <button class="back-btn-primary" @click="goBack">返回新闻列表</button>
    </div>
  </div>
</template>
